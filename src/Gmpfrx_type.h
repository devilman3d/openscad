...
#ifndef CGAL_GMPFRX_TYPE_H
#define CGAL_GMPFRX_TYPE_H

#ifdef CGAL_GMPFR_TYPE_H
#error "CGAL_GMPFR_TYPE_H already defined"
#endif
...
#else
		Gmpfr_rep() {}
		virtual ~Gmpfr_rep() { mpfr_clear(floating_point_number); }
#endif
};
